        ...
        >
            ...
            >
                ...
                <span className="h-12 w-12 rounded-full">
                    <img src="/image/no_image.jpg" alt="User" />
                </span>
            ...
            {dropdownOpen && (
                ...
                >
                    <ul className="flex flex-col gap-5 border-b border-stroke px-6 py-7.5 dark:border-strokedark">
                        <li>
                            <Link className="flex items-center gap-3.5 text-sm font-medium duration-300 ease-in-out hover:text-meta-3 lg:text-base">
                                <svg
                    ...
                    <Link
                        ...
                        method="post"
                        as="button"
                        className="flex items-center gap-3.5 px-6 py-4 text-sm font-medium duration-300 ease-in-out hover:text-meta-3 lg:text-base"
                    >
                        <svg
                            className="fill-current"
                            width="22"
