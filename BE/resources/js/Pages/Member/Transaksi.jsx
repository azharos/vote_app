...
export default function Transaksi({ Konfigurasi }) {
    const dataThead = [
        "Nomor Invoice",
        "ID Trx",
        "Item",
    ...
    return (
        <LayoutBE menuActive="Transaksi" logo={Konfigurasi.logo}>
            <div className="px-5 sm:px-0 space-y-5">
                <div className="font-secondary">
                    <h2 className="font-primary text-lg">Riwayat Transaksi</h2>
                    <p className="text-sm">
                ...
                <div className="p-6 border border-input grid gap-4 md:grid-cols-4 rounded-lg">
                    <div className="space-y-2">
                        ...
                        <input
                            ...
                            placeholder="#trxid $price @inputs"
                        />
                    </div>
                    <div className="space-y-2">
