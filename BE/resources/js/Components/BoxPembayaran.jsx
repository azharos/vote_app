...
const ListProgress = ({ no = 1, step = "progress" }) => {
    let color = {
        line: "",
        icon: "",
        text: "",
    ...
    if (step == "progress") {
        color = {
            line: "bg-muted",
            icon: "border-2 border-primary bg-background",
            text: "text-primary",
        };
        ...
        color = {
            line: "bg-muted",
            icon: "border-2 border-border-75 hover:border-input bg-background",
            text: "",
        };
    }
    ...
    if (no == 1) {
        return (
            <li className="pb-5 relative w-full">
                <div
                    className={`absolute left-0 top-4 -ml-px mt-0.5 h-0.5 w-full ${color.line}`}
                    aria-hidden="true"
                ></div>
                <div className="relative flex flex-col items-start">
                    <span className="flex h-9 items-center">
                        <span
                            className={`relative z-10 flex h-8 w-8 items-center justify-center rounded-full ${color.icon}`}
                        >
                            <svg
                                width="20"
                                height="20"
                    ...
                    <span className="ml-4 hidden w-full min-w-0 flex-col text-left lg:ml-0 lg:mt-2 lg:flex lg:text-left">
                        <span
                            className={`text-base font-semibold ${color.text}`}
                        >
                            Transaksi Dibuat
                        </span>
...
export const JumbotronPembayaran = ({ bgColor = "" }) => {
    if (bgColor == "success") {
        return (
            <div
                className={`w-full bg-success-75 flex flex-col justify-center items-center px-3 md:px-0 text-center`}
                style={{ height: "400px" }}
            >
                <div
                    className={`bg-success-50 size-20 rounded-full flex justify-center items-center text-4xl mb-16 shadow`}
                >
        ...
        return (
            <div
                className={`w-full bg-warning-75 flex flex-col justify-center items-center px-3 md:px-0 text-center`}
                style={{ height: "400px" }}
            >
                <div
                    className={`bg-warning-50 size-20 rounded-full flex justify-center items-center text-4xl mb-16 shadow`}
                >
                ...
                <h2 className="font-medium">
                    Pesanan kamu menunggu pembayaran sebelum dikirim.
                </h2>
            </div>
        );
        ...
        return (
            <div
                className={`w-full bg-danger-75 flex flex-col justify-center items-center px-3 md:px-0 text-center`}
                style={{ height: "400px" }}
            >
                <div
                    className={`bg-danger-50 size-20 rounded-full flex justify-center items-center text-4xl mb-16 shadow`}
                >
                ...
                <h2 className="font-medium">
                    Batas waktu pembayaran telah berakhir. Silahkan lakukan
                    pembelian ulang.
                </h2>
            </div>
        );
        ...
        return (
            <div
                className={`w-full bg-info-75 flex flex-col justify-center items-center px-3 md:px-0 text-center`}
                style={{ height: "400px" }}
            >
                <div
                    className={`bg-info-50 size-20 rounded-full flex justify-center items-center text-4xl mb-16 shadow`}
                >
                    <i className="fa-solid fa-close"></i>
                </div>
                <h2 className="text-2xl md:text-4xl font-bold mb-1">
                ...
                <h2 className="font-medium">
                    Transaksi sedang dalam proses. Mohon Tunggu ya.
                </h2>
            </div>
        );
    }
...
export const ProgressPembayaran = ({ bgColor = "", step = "" }) => {
    return (
        <div className="w-full">
            <ol className="flex w-full justify-between overflow-hidden">
                {step == "bayar" ? (
                    <>
                        <ListProgress no={1} step="success" />
                        <ListProgress no={2} step="progress" />
                        <ListProgress no={3} step="stage" />
                        <ListProgress no={4} step="stage" />
                    </>
                ) : step == "proses" ? (
                    <>
                        <ListProgress no={1} step="success" />
                        <ListProgress no={2} step="success" />
                        <ListProgress no={3} step="progress" />
                        <ListProgress no={4} step="stage" />
                    </>
                ) : step == "failed" ? (
                    <>
                        <ListProgress no={1} step="success" />
                        <ListProgress no={2} step="failed" />
                        <ListProgress no={3} step="stage" />
                        <ListProgress no={4} step="stage" />
                    </>
                ) : (
                    <>
                        <ListProgress no={1} step="success" />
                        <ListProgress no={2} step="success" />
                        <ListProgress no={3} step="success" />
                        <ListProgress no={4} step="success" />
                    </>
                )}
            </ol>
        </div>
